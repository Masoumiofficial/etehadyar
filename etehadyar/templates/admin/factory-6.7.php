...
jQuery(function($){
  ...
  $('#eaiwFactoryGen').on('click', function(){
    ...
    $.post(EAIW.ajax, {action:'eaiw_factory_generate', prompt:prompt, post_id:post_id, tone:$('#eaiwFactoryTone').val(), length:$('#eaiwFactoryLen').val(), save_draft:$('#eaiwFactoryDraft').is(':checked')?1:0, _ajax_nonce:EAIW.nonce}, res=>{
